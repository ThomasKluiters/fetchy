from fetchy import get_architecture, get_distribution, get_distribution_version, get_mirror, gather_exclusions
...
class FetchyConfig(object):
    def __init__(self, distribution=None, version=None, architecture=None, mirror=None, ppas=None, exclusions=None):
